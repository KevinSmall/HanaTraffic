sap.ui.controller("roadsafetymap.RTA_App", {

/**
* Called when a controller is instantiated and its View controls (if available) are already created.
* Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
* @memberOf roadsafetymap.RTA_App
*/
	onInit: function() {
		console.log("..in RTA_App.controller");
		var view = this.getView();
		// remember the App Control
		this.app = view.byId("RTA_App");
	...
	navToHandler : function(channelId, eventId, data) {
		if (data && data.id) {
			...
			if (this.app.getPage(data.id) === null) {
				...
				this.app.addPage(sap.ui.jsview(data.id, "roadsafetymap." + data.id));
			}
